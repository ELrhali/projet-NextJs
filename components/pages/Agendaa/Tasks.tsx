...
//   color: string ;
// }
// export const priorities: Prior[] = [
//   { id: 1, text: 'Low Priority', color: '#2e7d32' },
//   { id: 2, text: 'Medium Priority', color: '#03a9f4' },
//   { id: 3, text: 'High Priority', color: '#f4511e' },
// ];}
interface Ownerss {
  text: string ;
  id: number ;
